...
logger = WandbLogger(project='Raga Benchmark', name='Hindustani Training')
checkpoint_callback = ModelCheckpoint(
    monitor='val_accuracy',
    filepath=os.path.join(os.getcwd(), 'checkpoints/hindustani-training-{epoch:02d}-{val_accuracy:.2f}'),
    save_top_k=3,
    mode='max',
    verbose=True
)
